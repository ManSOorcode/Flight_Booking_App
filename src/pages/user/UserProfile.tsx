  ...
  return (
    <div className="min-h-screen   p-4">
      <div className="max-w-md mx-auto">
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl border border-white/50 p-8 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center p-3 bg-gray-50 rounded-xl">
              ...
              <div className="flex-1">
                ...
                <div className="text-gray-800 font-medium">{user.joinDate}</div>
              </div>
            </div>
          </div>
        </div>
