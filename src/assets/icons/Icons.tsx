...
export const ArrowRightLeftIcon: React.FC<{ className?: string }> = ({
  className = "",
}) => (
  <svg
    viewBox="0 0 24 24"
...
export const UserCheckIcon: React.FC<{ className: string }> = ({
  className,
}) => {
  return (
    <svg
...
export const BookingsIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    width="20"
...
export const RupeeIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M6 3h12M6 8h12m-3 5-4 4m0 0-4-4m4 4V8.5"
    />
  </svg>
);
...
export const PlaneTakeOffIcon: React.FC<{ className: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
